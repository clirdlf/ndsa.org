...
**Note:** All conference attendees are expected to abide by the [DLF’s Code of Conduct](https://www.diglib.org/about/code-of-conduct/), and proposals should be submitted in the spirit of [NDSA’s Values and Principles](https://ndsa.org/about/foundational-strategy/). 
...
Digital Preservation 2023 ([#DigiPres23](https://twitter.com/hashtag/digipres23)) is held in partnership with NDSA’s host organization, the Council on Library and Information Resources ([CLIR](https://www.clir.org/)). Separate calls are being issued for CLIR’s 2023 events, the [2023 DLF Forum](https://forum2023.diglib.org/) (November 13-15) and associated workshop series [Learn@DLF](https://forum2023.diglib.org/affiliated-events/learndlf/) (November 12). CLIR, DLF, and NDSA strive to create a safe, accessible, welcoming, and inclusive event, and adheres to [DLF’s Code of Conduct](https://www.diglib.org/about/code-of-conduct/).
